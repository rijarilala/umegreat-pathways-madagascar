...
import linkedinImage from "@/assets/formations/linkedin.jpg";
import { 
  Linkedin, 
  Target, 
  CheckCircle, 
  ...
  return (
    <div className="space-y-0">
      ...
      <section 
        ...
        style={{
          backgroundImage: `linear-gradient(rgba(var(--primary-rgb), 0.8), rgba(var(--primary-rgb), 0.8)), url(${linkedinImage})`,
